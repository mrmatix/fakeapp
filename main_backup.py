...
while True:
    ...
    search_input = input(
        "Do you want to search for this phrase in Reuters / BBC / Google / NYTimes / or Quit? (R for Reuters/B for BBC/G for GOOGLE/N for NYTimes/Q for QUITTING THE PROGRAM): ")
    print(search_input)
